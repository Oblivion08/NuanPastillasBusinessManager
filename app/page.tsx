    ...
    try {
      ...
      if (kind === "sale") {
        ...
        await runTransaction(db,async tx=>{
          ...
          const original=data.sales.find(s=>s.id===saleId),unitPrice=oldProductId===productId&&original?original.unitPrice:newProduct.price,unitCost=oldProductId===productId&&original?original.unitCost:newProduct.cost,total=qty*unitPrice-discount;
